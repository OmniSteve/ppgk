  ...
  return (
    <div className="min-h-screen text-foreground">
      <div className="max-w-3xl mx-auto px-6 py-16">
        ...
        <p className="text-muted-foreground mb-8">Last updated: January 2025 · Premier Performance Goalkeeping · Malta</p>
        <div className="prose prose-invert max-w-none space-y-6 text-muted-foreground">
          ...
          <section>
            <h2 className="text-xl font-bold text-foreground mb-3">2. Booking and Cancellation Policy</h2>
          ...
          <section>
            <h2 className="text-xl font-bold text-foreground mb-3">3. Session Credits and Packages</h2>
          ...
          <section>
            <h2 className="text-xl font-bold text-foreground mb-3">4. Payments</h2>
          ...
          <section>
            <h2 className="text-xl font-bold text-foreground mb-3">5. Health and Safety</h2>
          ...
          <section>
            <h2 className="text-xl font-bold text-foreground mb-3">6. GDPR and Data Protection</h2>
