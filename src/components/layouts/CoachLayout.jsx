  ...
  const SidebarContent = () => (
    <div className="flex flex-col h-full">
      ...
      <div className="p-4 border-t border-white/10">
        ...
        <button onClick={handleSignOut} className="flex items-center gap-2 w-full px-3 py-2 rounded-lg text-sm text-slate-400 hover:bg-white/10 hover:text-white transition-all">
          <LogOut size={16} />
          Sign Out
        </button>
      </div>
  ...
  return (
    <div className="min-h-screen bg-slate-50 flex">
      ...
      <div className="flex-1 lg:ml-64 flex flex-col min-h-screen">
        <header className="lg:hidden bg-[#0D1B2A] px-4 py-3 flex items-center justify-between">
